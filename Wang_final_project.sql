...
CREATE TABLE `delivery` (
  ...
  KEY `delivery_order_fk` (`oid`),
  CONSTRAINT `delivery_order_fk` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `delivery_chk_1` CHECK ((`distance` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `delivery` VALUES ('11797027ZBPXQNW7','156 Howard Ave, Boston, MA 02125',2.8,'2020-04-19 19:00:00','2020-04-19 18:55:40',2),('9374889698090457886949','156 Howard Ave, Boston, MA 02125',3.8,'2020-07-31 13:00:00','2020-07-31 13:11:10',4);
...
CREATE TABLE `item` (
  ...
  PRIMARY KEY (`item_id`),
  KEY `menu_fk` (`rid`),
  CONSTRAINT `menu_fk` FOREIGN KEY (`rid`) REFERENCES `restaurant` (`rid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `item_chk_1` CHECK ((`status` in (_utf8mb4'available',_utf8mb4'not available')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `item` VALUES (1,'New England Clam Chowder','A New England favorite seasoned with our own blend of spices',12,'Available',1),(2,'Pan-Fried Calamari with Hot Cherry Peppers','Our signature appetizer – crisp and golden with a fiery flavor',20,'Available',1),(3,'Cloudy Bay Sauvignon Blanc',NULL,83,'Available',1),(4,'Coconut Cream Pie','With house made caramel sauce and a hint of rum',12,'Available',1),(5,'Creamed Spinach',NULL,20,'Not Available',1),(6,'Chilled Shrimp Cocktail',NULL,16.95,'Available',2),(7,'Mussels','Basque Style. Steamed with Garlic and White Wine, \n Garlic Bread',15.95,'Available',2),(8,'Cold Seafood Sampler','Shucked Oysters, Cherrystone Clams & Shrimp',18.95,'Available',2),(9,'Fish Sandwich','w/ aged cheddar cheese',15.95,'Available',2),(10,'Homemade Lump Crab Cakes','Ye olde recipe, with lemon aioli',22.95,'Available',2);
...
CREATE TABLE `manager` (
  ...
  PRIMARY KEY (`user_id`),
  KEY `manager_staff_fk` (`sid`),
  CONSTRAINT `manager_staff_fk` FOREIGN KEY (`sid`) REFERENCES `staff` (`sid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `manager` VALUES ('6178882391',9,'John.ria','riaj0321'),('2522341267',1,'katM','kate123');
...
CREATE TABLE `order_item` (
  ...
  KEY `item_id` (`item_id`),
  CONSTRAINT `order_item_ibfk_1` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `order_item_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
INSERT INTO `order_item` VALUES (1,1,2),(1,2,2),(2,1,6),(2,2,6),(2,3,2),(3,4,1),(4,10,1),(5,5,1),(5,10,1),(6,10,1),(7,7,1),(7,8,1),(7,9,1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `prevent_insert_past_order` BEFORE INSERT ON `order_item` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `prevent_update_past_order` BEFORE UPDATE ON `order_item` FOR EACH ROW BEGIN
DECLARE order_paid INT;
SELECT EXISTS(SELECT * FROM payment WHERE oid = NEW.oid) INTO order_paid;
IF order_paid = 1 THEN
SIGNAL SQLSTATE '45000'
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `prevent_delete_past_order` BEFORE DELETE ON `order_item` FOR EACH ROW BEGIN
DECLARE order_paid INT;
...
--
-- Table structure for table `order_prepares`
--
...
CREATE TABLE `order_prepares` (
  ...
  KEY `chef_id` (`chef_id`),
  CONSTRAINT `order_prepares_ibfk_1` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `order_prepares_ibfk_2` FOREIGN KEY (`chef_id`) REFERENCES `staff` (`sid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `order_prepares`
--

LOCK TABLES `order_prepares` WRITE;
/*!40000 ALTER TABLE `order_prepares` DISABLE KEYS */;
INSERT INTO `order_prepares` VALUES (4,5),(7,5),(5,18),(6,18),(1,21),(2,21),(3,21),(1,35),(2,35);
/*!40000 ALTER TABLE `order_prepares` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `prevent_insert_past_order_chef` BEFORE INSERT ON `order_prepares` FOR EACH ROW BEGIN
DECLARE order_paid INT;
SELECT EXISTS(SELECT * FROM payment WHERE oid = NEW.oid) INTO order_paid;
IF order_paid = 1 THEN
SIGNAL SQLSTATE '45000'
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `prevent_delete_past_order_chef` BEFORE DELETE ON `order_prepares` FOR EACH ROW BEGIN
DECLARE order_paid INT;
SELECT EXISTS(SELECT * FROM payment WHERE oid = OLD.oid) INTO order_paid;
IF order_paid = 1 THEN
SIGNAL SQLSTATE '45000'
...
CREATE TABLE `orders` (
  ...
  KEY `order_waiter_fk` (`sid`),
  CONSTRAINT `order_customer_fk` FOREIGN KEY (`cid`) REFERENCES `customer` (`cid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `order_waiter_fk` FOREIGN KEY (`sid`) REFERENCES `staff` (`sid`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `orders_chk_1` CHECK ((`orderType` in (_utf8mb4'Dine-in',_utf8mb4'Delivery'))),
  CONSTRAINT `orders_chk_2` CHECK ((`status` in (_utf8mb4'completed',_utf8mb4'uncompleted',_utf8mb4'aborted')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,'2020-01-01','Dine-in',1,15,'completed'),(2,'2020-04-19','Delivery',3,17,'completed'),(3,'2020-07-28','Dine-in',2,15,'completed'),(4,'2020-07-31','Delivery',2,3,'completed'),(5,'2020-08-01','Dine-in',5,30,'completed'),(6,'2020-08-11','Dine-in',4,3,'completed'),(7,'2020-08-30','Dine-in',1,13,'completed');
...
CREATE TABLE `payment` (
  ...
  `oid` int NOT NULL,
  PRIMARY KEY (`pid`),
  KEY `payment_customer_fk` (`cid`),
  KEY `payment_order_fk` (`oid`),
  CONSTRAINT `payment_customer_fk` FOREIGN KEY (`cid`) REFERENCES `customer` (`cid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `payment_order_fk` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `payment_chk_1` CHECK ((`amount` >= 0)),
  CONSTRAINT `payment_chk_2` CHECK (((`discount` >= 0) and (`discount` <= 1.0))),
  CONSTRAINT `payment_chk_3` CHECK ((`paymentType` in (_utf8mb4'cash',_utf8mb4'check',_utf8mb4'credit card',_utf8mb4'debit card')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment` VALUES (1,'2020-01-01 13:48:00',75.52,0,'cash',1,1),(2,'2020-04-19 18:21:23',278,0.3,'credit card',3,2),(3,'2020-07-28 11:50:21',15.01,0,'debit card',2,3),(4,'2020-07-31 12:21:21',23.8,0,'credit card',3,4),(5,'2020-08-01 17:51:21',50.02,0,'credit card',5,5),(6,'2020-08-12 01:10:12',28.82,0.1,'cash',4,6),(7,'2020-08-30 19:00:01',57.8,0,'credit card',1,7);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `complete_order` AFTER INSERT ON `payment` FOR EACH ROW BEGIN
UPDATE orders
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `uncomplete_order_payment_cancel` AFTER DELETE ON `payment` FOR EACH ROW BEGIN
UPDATE orders
...
CREATE TABLE `restaurant` (
  ...
  `status` varchar(20) NOT NULL,
  PRIMARY KEY (`rid`),
  CONSTRAINT `restaurant_chk_1` CHECK ((`status` in (_utf8mb4'open',_utf8mb4'closed',_utf8mb4'permanently closed')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `status_after_close` AFTER UPDATE ON `restaurant` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `status_after_open` AFTER UPDATE ON `restaurant` FOR EACH ROW BEGIN
...
CREATE TABLE `staff` (
  ...
  `rid` int NOT NULL,
  PRIMARY KEY (`sid`),
  KEY `staff_restaurant_fk` (`rid`),
  CONSTRAINT `staff_restaurant_fk` FOREIGN KEY (`rid`) REFERENCES `restaurant` (`rid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `staff_chk_1` CHECK ((`status` in (_utf8mb4'active',_utf8mb4'blocked'))),
  CONSTRAINT `staff_chk_2` CHECK ((`position` in (_utf8mb4'manager',_utf8mb4'waiter',_utf8mb4'chef')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `staff` VALUES (1,'Katelyn','Monroe','active','manager',1),(3,'Linda','Sandoval','active','waiter',2),(5,'Alexandra','Ashley','active','chef',2),(8,'Bella','York','blocked','waiter',1),(9,'Ria','Johnston','active','manager',2),(10,'Cory','Stokes','blocked','manager',1),(13,'Manisha','Love','active','waiter',2),(15,'Shanta','Hardy','active','waiter',1),(17,'Jerry','Hart','active','waiter',1),(18,'Fatima','Camacho','active','chef',2),(21,'Lisa','Oconnor','active','chef',1),(30,'Ari','Lawson','active','waiter',2),(35,'Amy','Trujillo','active','chef',1);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `delete_manager_after_update` AFTER UPDATE ON `staff` FOR EACH ROW BEGIN
...
/*!50106 DROP EVENT IF EXISTS `monthly_abort_unfinished_orders` */;
DELIMITER ;;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `monthly_abort_unfinished_orders` ON SCHEDULE EVERY 1 MONTH STARTS '2020-01-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
UPDATE orders
SET status = 'aborted' 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `check_author`(user_id_ VARCHAR(255), pwd VARCHAR(255)) RETURNS int
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_all_orders_customer` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_all_orders_customer`(cid_ INT) RETURNS int
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_num_orders` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_num_orders`(from_ DATE, to_ DATE) RETURNS int
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `total_amount`(rid_ INT) RETURNS double
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `delete_ordered_item` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `delete_order_prepares` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_customer_payments` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_monthly_num_orders` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_open_restaurant` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_ordered_items` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_position_rid_staff` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_rid_payments` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_rid_staff` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_sid_staff` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_staff` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_order_prepares` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_restaurant` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `return_customer_past_orders` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `return_top_ordered_item` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `show_menu` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `take_orders` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_item_price` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_item_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_staff_position` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_staff_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2020-12-10 18:26:34
